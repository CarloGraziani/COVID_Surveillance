...
class ViralDynamics(ODE_model):
    ...
    Constructor Args:
      ...
      params (`Tensor`[...,:]) Model parameters.  Leftmost indices denote
        chains.
          params[...,0]: l, "natural birth rate of cells"
          params[...,1]: mu, "natural death rate of cells"
          params[...,2]: beta, "rate at which virus infects host cells"
          params[...,3]: alpha, "per capita attrition rate of infected cells"
          params[...,4]: c, "production rate of free virions"
          params[...,5]: gamma, "per capita attrition rate of virions"
